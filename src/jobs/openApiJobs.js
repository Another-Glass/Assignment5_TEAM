...
async function getOpenApiData() {
  ...
  while (1) {
    try {
      url = "https://api.odcloud.kr/api/3074271/v1/uddi:cfc19dda-6f75-4c57-86a8-bb9c8b103887?page="+page+"&perPage=100&serviceKey=" + secretKey;
      ...
      //DB 함수 호출
      trialService.createOrUpdateTrials(trials);
